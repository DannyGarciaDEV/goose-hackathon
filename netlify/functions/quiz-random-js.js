    ...
    try {
        ...
        if (letters.length === 0) {
            return {
                ...
                headers: headers,
                body: JSON.stringify({
                    error: "No letters found in dataset",
        ...
        console.log(`Selected random letter: ${randomLetter}`);
        ...
        return {
            ...
            body: JSON.stringify({
                letter: randomLetter,
                image_url: `/api/letter-js/${randomLetter}`,
                datasetPath: datasetPath,
        ...
        console.error('Error in quiz-random function:', error);
        return {
            statusCode: 500,
            headers: headers,
            body: JSON.stringify({
